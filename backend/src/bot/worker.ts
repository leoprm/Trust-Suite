...
const STRINGS: Record<string, Record<string, string>> = {
  ...
  no_tasks:         { es: "No hay tareas disponibles que coincidan con tus skills.\n\nRevisa mas tarde — las skills se obtienen completando tareas.", en: "No available tasks matching your skills.\n\nCheck back later — skills are earned by completing tasks." },
  ...
  help_trabajar:    { es: "Registrarte como worker (tarifa, ubicacion)", en: "Register as a worker (rate, location)" },
