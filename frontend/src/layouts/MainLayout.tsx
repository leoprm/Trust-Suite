...
import { LogOut, Globe, Shield, CheckSquare, Users, TrendingUp } from 'lucide-react';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', width: '100vw', overflow: 'hidden', background: 'var(--bg-primary)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', width: '100vw', overflow: 'hidden' }}>
        ...
        {/* Dynamic Content */}
        {showContent && (
          <main style={{ flex: 1, overflowY: 'auto', position: 'relative', background: 'var(--bg-primary)', paddingBottom: isMobile ? '0' : '0' }}>
            <Outlet />
          </main>
        )}
      </div>
