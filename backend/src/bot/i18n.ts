...
export async function initI18n(): Promise<void> {
  ...
  await i18next.use(Backend).init({
    ...
    supportedLngs: ['es', 'en'],
    preload: ['es', 'en'],
    ns: ['common', 'onboarding', 'tree', 'needs', 'voting', 'errors', 'dm', 'kanban', 'hilt', 'v1', 'v1_candidate', 'v1_vote', 'hiring'],
    defaultNS: 'common',
    backend: {
 ...
 */
const KNOWN_NS = new Set(['common', 'onboarding', 'tree', 'needs', 'voting', 'errors', 'dm', 'kanban', 'hilt', 'v1', 'v1_candidate', 'v1_vote', 'hiring']);
